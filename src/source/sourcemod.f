...
c
      ...
      integer(i8),allocatable :: src_nvacantall(:) !(nmpi) number of vacancies on each of the ranks
c
c-- source sampling for output
      real(dp),allocatable :: src_energy(:,:) !(grd_ncell,grp_ng) spectral energy distribution of particles for each cell
